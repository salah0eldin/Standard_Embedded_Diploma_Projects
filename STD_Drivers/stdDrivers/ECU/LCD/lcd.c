 ...
 * File Name: lcd.c
 *
 * Description: This file contains the implementation of functions to control
 *              an LCD display, including initialization, command sending,
 *              and character/string display.
 *
...
void LCD_displayNumber(sint32 num) {
	...
	char buffer[16]; /* Buffer to hold the converted number */
